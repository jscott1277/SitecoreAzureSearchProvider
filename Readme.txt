...
5. Copy the Jarstan.Settings.config to the web_root\App_Config\Include\Jarstan.ContentSearch folder (One time step)
...
11. Click the 'Rebuild' button (NOTE:  The Root property of the Crawler is set to /sitecore/media library by default, so only those items will be indexed.  This value is available in the App_Config/Include/Jarstan.ContentSearch/Jarstan.ContentSearch.AzureMaster.config file)
